 ...
 * 创建商家模块
 */
ctrls_admin.controller('CreateBusinessCtrl',['$scope','$rootScope','toaster','ActionService','mixin',
function($scope, $rootScope, toaster, Action, _mixin){
	...
	$scope.create = function(valid) {
		...
		Action.createBusiness(business, createBusinessSuccess ,failure);
	}
	// 重置
	...
	function createBusinessSuccess(result){
		toaster.pop({ type: 'success', body: '创建商家 ' + $scope.business.account +' 成功', timeout: 3000 })
	}
