...
public class TokenReqBodyVo {
	...
	public TokenReqBodyVo() {	}
	
	public TokenReqBodyVo(String component_appid, String appSecret, String tickey) {
		this.component_appid = component_appid;
		this.component_appsecret = appSecret;
		this.component_verify_ticket = tickey;
	}
	
	public TokenReqBodyVo(String component_appid, String authorization_code) {
		this.component_appid = component_appid;
		this.authorization_code = authorization_code;
	}
	
	public TokenReqBodyVo(String component_appid) {
		this.component_appid = component_appid;
	}
