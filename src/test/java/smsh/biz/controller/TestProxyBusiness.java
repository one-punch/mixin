 ...
 * @author benko
 * @version 2016年6月13日
 * @see TestProxyBusiness
 * @since
 */
@SuppressWarnings("unused")
public class TestProxyBusiness extends BaseControllerTest {
    /** springmvc 上下文*/
    @Autowired
...
//        generateFactory.role.generate(true);
     ...
     */
    @Test
    public void test_isProxyAncestry() throws Exception {

/*        assertTrue(proxyBusinessService.isProxyAncestry(9L, 8L));
        assertFalse(proxyBusinessService.isProxyAncestry(9L, 9L));
        assertFalse(proxyBusinessService.isProxyAncestry(8L, 9L));*/
        BusinessInfoPo parent = userDao.proxyParentBy(9L);
        System.out.println();
